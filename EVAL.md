...
| Scanner                                         | TP  | FP  | FN  | Bugs Caught | Precision | Recall | F1   |
| ----------------------------------------------- | --- | --- | --- | ----------- | --------- | ------ | ---- |
| Semgrep alone (on all vulnerabilities)          | 14  | 1   | 3   | 14/38       | 93.3%     | 36.8%  | 0.53 |
| LLM reviewer alone (excluding Semgrep findings) | 22  | 3   | 16  | 22/24       | 88.0%     | 91.7%  | 0.90 |
| Hybrid (union)                                  | 36  | 4   | 2   | 36/38       | 90.0%     | 94.7%  | 0.92 |


**LLM-only contribution:** 22 planted findings were detected by the LLM reviewer but missed by Semgrep.  
Semgrep was graded on all 38 vulnerabilities. LLM was graded on the remaining 24 vulnerabilities not found by semgrep.  
Note: Semgrep's rule set does not cover 21 of the 24 vulnerabilities it didn't catch.
